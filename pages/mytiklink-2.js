    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 pt-28 pb-16 text-center">
        ...
        <h1 className="text-3xl font-extrabold leading-tight mb-6">
          Your WhatsApp Link Not Working on your tiktok bio?
        ...
        <p className="text-gray-300 text-lg leading-relaxed mb-10">
          If your WhatsApp link has never worked on your TikTok bio. People are
          clicking your whatsapp link but it’s not opening.
